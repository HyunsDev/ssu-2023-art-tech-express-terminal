...
def load_button_images():
    ...
    save_deactive_images = load_image("works/work3/source/btn/save-deactive.png")

    # btn1 - red image
    for i in range(4):
        light_img.append(
            load_image(f"works/work3/source/btn1_light/light-red-{100 + (i*50)}.png")
        )
        light_img.append(
            load_image(f"works/work3/source/btn1_light/light-yellow-{100 + (i*50)}.png")
        )
        light_img.append(
            load_image(f"works/work3/source/btn1_light/light-blue-{100 + (i*50)}.png")
        )
    ...
    error_images = load_image("works/work3/source/btn5_error/error.png")
